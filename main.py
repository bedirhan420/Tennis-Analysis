...
def main():
    #Read Video
    input_video_path = "inputs/input_video2.mp4"
    video_frames = read_video(input_video_path) 
    
    is_read_stub = False
    #Detect Players
    player_tracker = PlayerTracker(model_path="yolov8x")
    player_detections = player_tracker.detect_frames(video_frames,read_from_stub=is_read_stub,stub_path="tracker_stubs/player_detections.pkl ")
    ball_tracker = BallTracker(model_path="models/last.pt")
    ball_detections = ball_tracker.detect_frames(video_frames,read_from_stub=is_read_stub,stub_path="tracker_stubs/ball_detections.pkl ")
    ...
    save_video(output_video_frames,"output_videos/output_video2.mp4")
